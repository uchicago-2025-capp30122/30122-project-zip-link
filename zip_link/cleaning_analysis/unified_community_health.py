...
if __name__ == "__main__":
    pdf_file_path = '/home/vyshnaviv/capp122/30122-project-zip-link/zip_link/data/raw/community_health_ctr/HealthCentre1.pdf'
    csv_file_path = '/home/vyshnaviv/capp122/30122-project-zip-link/zip_link/data/raw/community_health_ctr/healthcentre_pdf.csv'
...
def join_health_df():
    pdf_data = process_health_data("/home/vyshnaviv/capp122/30122-project-zip-link/zip_link/data/raw/community_health_ctr/healthcentre_pdf.csv")
    hrsa_data = get_hrsa_data("/home/vyshnaviv/capp122/30122-project-zip-link/zip_link/data/raw/community_health_ctr/HRSA_Data.csv")
    ...
    cleaned_data.to_csv("/home/vyshnaviv/capp122/30122-project-zip-link/zip_link/data/preprocessed/unified_community_health_data.csv", index=False)
    zip_counts = cleaned_data["Zip Code"].value_counts().reset_index()
    zip_counts.columns = ["Zip Code", "cnt_comm_health_ctr"]
    zip_counts.to_csv("/home/vyshnaviv/capp122/30122-project-zip-link/zip_link/data/preprocessed/unified_community_health_count.csv", index=False)
